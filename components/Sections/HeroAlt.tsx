...
const HeroAlt: React.FC = () => {
  ...
  return (
    <>
      <section id="home-alt" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-50/70 via-white to-orange-50/30 pt-16">
